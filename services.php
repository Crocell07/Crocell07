...
?>
<body style=" background-image: linear-gradient(to right, #2980B9 , #6DD5FA, #FFFFFF);">
<div class="content py-5" style=" background-image: linear-gradient(to right, #C6FFDD , #FBD786,  #f7797d);">
